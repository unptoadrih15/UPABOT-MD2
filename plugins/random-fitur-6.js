...
let handler = async(m, { conn, usedPrefix, groupMetadata, text, args, command }) => {
let frep = { contextInfo: { externalAdReply: {title: global.wm, body: global.author, sourceUrl: null, thumbnail: fs.readFileSync('./thumbnail.jpg')}}}
let fdoc = {quoted:{key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `${command}`}}}}
let ps = groupMetadata.participants.map(v => v.id)
let imgr = ps.getRandom()
